    ...
    <div className="min-h-screen bg-[#f4f6f4] text-stone-900 flex flex-col font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="flex-1 flex w-full max-w-[1600px] mx-auto relative">
        ...
        <div className="flex-1 flex flex-col min-w-0 w-full overflow-x-hidden">
          ...
          {/* TOP HEADER BAR */}
          <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-stone-200/80 px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0 max-w-xl">
              ...
              <div className="relative flex-1 min-w-0">
                ...
                <input
                  ...
                  className="w-full pl-8 sm:pl-9 pr-8 sm:pr-14 py-1.5 sm:py-2 bg-stone-100/80 border border-stone-200/70 rounded-full text-xs font-medium text-stone-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:bg-white transition-all placeholder:text-stone-400 truncate"
                />
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 p-1 pl-1 sm:pl-1.5 pr-1.5 sm:pr-2.5 bg-white hover:bg-stone-50 rounded-full border border-stone-200/90 shadow-2xs cursor-pointer transition-colors"
                >
