    ...
    <div className="min-h-screen bg-[#f4f6f4] text-stone-900 flex flex-col font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="flex-1 flex w-full max-w-[1600px] mx-auto relative">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {/* TOP HEADER BAR */}
          <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-stone-200/80 px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 flex-1 max-w-xl">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-14 py-2 bg-stone-100/80 border border-stone-200/70 rounded-full text-xs font-medium text-stone-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:bg-white transition-all placeholder:text-stone-400"
                />
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="relative">
                ...
                {/* Notifications Popup */}
                {isNotificationsOpen && (
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-stone-200 p-4 z-50 animate-scaleUp space-y-3">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-[#1b4332] text-white flex items-center justify-center font-black text-xs shadow-xs">
                    {userInitial}
                  </div>
                ...
                {isProfileDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-stone-200 p-3 z-50 animate-scaleUp space-y-2">
